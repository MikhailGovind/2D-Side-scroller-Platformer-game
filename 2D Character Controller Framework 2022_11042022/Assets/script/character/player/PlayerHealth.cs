...
public class PlayerHealth : MonoBehaviour
{
    ...
    public GameObject HPHeart_1;
    public GameObject HPHeart_2;
    public GameObject HPHeart_3;
    public GameObject GreyHPHeart_1;
    public GameObject GreyHPHeart_2;
    public GameObject GreyHPHeart_3;

    void Awake()
    {
        _lvlMngr = GameObject.FindGameObjectWithTag("New Level Manager").GetComponent<LevelManager>();
    ...
    void Update()
    {
        ...
        if (_currentHealth == 0)
        {
            HPHeart_1.SetActive(false);
            HPHeart_2.SetActive(false);
            HPHeart_3.SetActive(false);
        }

        if (_currentHealth == 1)
        {
            HPHeart_1.SetActive(true);
            HPHeart_2.SetActive(false);
            HPHeart_3.SetActive(false);
        }
